...
from tests import test_syntax, test_targeted
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="run_tests", description="Run extension tests."
    )
    # Flag arguments
    parser.add_argument(
        "--update",
        ...
        action="store_true",
        default=False,
        help="Update expected HTML output.",
    )
    parser.add_argument(
        "--test-target",
        "-t",
    ...
    parser.add_argument(
        ...
        action="store",
        default="",
        help="Test or update specific test.",
    )
